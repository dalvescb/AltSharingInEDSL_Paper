...
\end{minted}
the function \mintinline{haskell}{novel} will exhibit an issue in sharing of
...
explosion of hashcons operations, and trying to adapt the let construct above,
...
We used this language to implement approximations of vector cos and tan (i.e., a
...
\begin{figure}[!h]
  ...
  \caption{Comparison of cos using hashcons vs triecons}
...
\begin{figure}[!h]
  ...
  \caption{Comparison of tan using no explicit sharing vs explicit}
